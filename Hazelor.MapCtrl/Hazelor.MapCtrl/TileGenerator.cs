...
namespace Hazelor.MapCtrl
{
    ...
    public static class TileGenerator
    {
        ...
        //private const string TileFormat = @"J:\Works\Maps\googlemaps/{0}/{1}/{2}.png";
        private const string TileFormat = @"http://webst04.is.autonavi.com/appmaptile?style=6&x={1}&y={2}&z={0}";
